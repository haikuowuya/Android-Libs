...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-info">
            ...
            <h4><i class="fa fa-fw fa-info"></i> We are merging!</h4>
            <p>
                The creator of <a href="http://androidlibs.org" target="_blank">androidlibs.org</a> is now working together
                with Android-Libs. We have a new developer and as a plus new libraries coming!
            </p>
        </div>
    </div>
</div>
